...
export const VideosTab: React.FC<VideosTabProps> = React.memo(({ videos, addVideo, deleteVideo }) => {
            ...
            <button
              ...
              className={cn(
                ...
                filter === opt
                  ...
                  : 'bg-surface-elevated text-on-surface-variant hover:bg-primary/10 hover:text-primary',
              )}
            >
              {statusLabels[opt]}
            </button>
          ...
          <AnimatePresence mode="popLayout">
            {filtered.map((video) => (
              <motion.div
                ...
                className="bg-surface rounded-xl overflow-hidden border border-white/[0.04] group cursor-pointer"
              >
                {/* Thumbnail */}
                <div className="aspect-video relative overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-white/[0.03] group-hover:bg-black/40 transition-colors flex items-center justify-center">
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      if (window.confirm(t('confirmDeleteVideo'))) deleteVideo(video.id);
                    }}
      ...
      <AnimatePresence>
        {showModal && (
          <>
            ...
            >
              <div role="dialog" aria-modal="true" aria-label={t('addVideo')} className="bg-surface rounded-2xl shadow-2xl border border-white/[0.06] w-full max-w-md pointer-events-auto">
                {/* Modal header */}
                <div className="flex items-center justify-between p-5 border-b border-white/[0.04]">
                  ...
                  <button
                    aria-label={t('close')}
                    onClick={() => setShowModal(false)}
                    className="w-7 h-7 rounded-full bg-surface-elevated flex items-center justify-center text-on-surface-variant hover:text-on-surface transition-colors"
                  >
                    <X className="w-4 h-4" />
                  </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-5 space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-surface-elevated border border-white/[0.04] rounded-lg px-3 py-2 text-xs text-on-surface placeholder:text-on-surface-variant/50 focus:outline-none focus:ring-2 focus:ring-primary/30"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-surface-elevated border border-white/[0.04] rounded-lg px-3 py-2 text-xs text-on-surface focus:outline-none focus:ring-2 focus:ring-primary/30"
                      >
